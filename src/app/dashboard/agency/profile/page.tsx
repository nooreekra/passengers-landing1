        ...
        <div className="space-y-4">
            ...
            <div className="bg-white rounded-lg shadow-sm p-4">
                        ...
                        <div className="space-y-2 text-sm">
                            ...
                            <div className="flex gap-1">
                                <span className="text-gray-500 flex items-center gap-2">
                                    {t("profile.ain")}
                                    <InfoTooltip
                                        text="AIN (Agent Identification Number) - уникальный идентификационный номер тревел-агента в системе IMS"
                                        position="right"
                                    />
                                    :
                                </span>
                ...
                <div className="grid md:grid-cols-2 gap-5">
                    ...
                    <div className="bg-purple-50 rounded-lg p-4 self-start">
                        <h4 className="text-base font-semibold text-purple-900 mb-3">{t("profile.agencyInfo")}</h4>
                        <div className="space-y-3 text-sm">
                            <div>
                                <div className="text-purple-600 mb-1">{t("profile.businessType")}</div>
                                <div className="font-bold text-purple-900">{dash(splitCamelCase(data.type))}</div>
                            </div>
                            <div>
                                ...
                                <div className="font-bold text-purple-900">{dashArray(data.iataValidator)}</div>
                            </div>
                            <div>
                                <div className="text-purple-600 mb-1 flex items-center gap-1">
                                ...
                                <div className="font-bold text-purple-900">{dashArray(data.pseudoCityCode)}</div>
                            </div>
                            {data.ticketingAuthority === false && (
                                <div>
                                    ...
                                    <div className="font-bold text-purple-900">{dashArray(data.officeIds)}</div>
                                </div>
                            )}
                        </div>
                    </div>
