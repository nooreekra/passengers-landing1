...
export default function AddPromoLayout({ children }: PropsWithChildren) {
    ...
    const steps = [
        { label: t("promo.step_description"),      href: "/dashboard/partnership/promos/add/step-1" },
        { label: t("promo.step_promo_rules"),      href: "/dashboard/partnership/promos/add/step-2" },
        { label: t("promo.step_rewards_and_fees"), href: "/dashboard/partnership/promos/add/step-3" },
    ];
