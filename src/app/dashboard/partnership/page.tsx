...
import { getPartnershipPromos } from "@/features/promo/api/promos";
import PromoPartnershipTable from "@/features/promo/tables/PromoPartnershipTable";
...
const PartnershipDashboardPage = () => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            setLoading(true);
            try {
                const res = await getPartnershipPromos(offset, limit, debouncedSearchTerm, dateRange);
                setPromos(res.items);
                setTotal(res.total);
            } finally {
                setLoading(false);
            ...
            <div className="flex flex-wrap flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                {canCreatePromo && (
                    <Button
                        ...
                        onClick={() => router.push("/dashboard/partnership/promos/add/step-1")}
                    >
...
export default PartnershipDashboardPage;
