...
const PromoAgencyTable = ({ promos, loading, offset, limit, total, onPageChange }: Props) => {
                ...
                <table className="w-full bg-white shadow-md table-auto text-sm border border-border-default">
                    ...
                    {promos.filter(promo => promo.status !== "Unpublished").map((promo) => (
                        <tr
                            ...
                            onClick={() => router.push(`/dashboard/agency/promos/${promo.id}/view`)}
                        >
                                        ...
                                        >
                                            {promo.name}
                                                            ...
                                                            <span
                                                                ...
                                                                className="text-xs text-gray-500 min-w-0 overflow-hidden whitespace-nowrap
                                                    [mask-image:linear-gradient(to_right,black_85%,transparent)]"
                                                            >
...
export default PromoAgencyTable;
